...
export default function StickyPhoneButton({ navigate: _navigate }: StickyPhoneButtonProps = {}) {
  ...
  return (
    <div className={`fixed bottom-4 ${isRTL ? 'left-4 items-start' : 'right-4 items-end'} z-50 flex flex-col gap-2`}>
      ...
      >
        <div className="relative flex items-center justify-center w-9 h-9 rounded-full bg-white/20 shrink-0">
        ...
        <div className="flex flex-col text-left rtl:text-right">
          <span className="text-[10px] uppercase font-bold text-blue-200 tracking-wider">{dict.common.callUs}</span>
