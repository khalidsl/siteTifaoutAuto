...
const mockProducts = [
  {
    ...
    price: 1850,
    oldPrice: 2200,
    imageUrl: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=600&fit=crop&auto=format',
  ...
  },
  {
    ...
    price: 1650,
    oldPrice: 1950,
    imageUrl: 'https://images.unsplash.com/photo-1625047509168-a7026f36de04?w=600&h=600&fit=crop&auto=format',
  ...
  },
  {
    ...
    brand: 'Denso',
    price: 1980,
    imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=600&fit=crop&auto=format',
  ...
  },
  {
    ...
    price: 3200,
    oldPrice: 4100,
    imageUrl: 'https://images.unsplash.com/photo-1620714223084-8fcacc2dfd4d?w=600&h=600&fit=crop&auto=format',
  ...
  },
  {
    ...
    brand: 'Delphi',
    price: 2750,
    imageUrl: 'https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?w=600&h=600&fit=crop&auto=format',
  ...
  },
  {
    ...
    brand: 'Multimarque',
    price: 85,
    imageUrl: 'https://images.unsplash.com/photo-1601362840469-51e4d8d58785?w=600&h=600&fit=crop&auto=format',
    compatibleVehicles: ['Universel — voir description', 'Injecteurs M22×1.5', 'Injecteurs M26×1.5'],
  ...
  },
  {
    ...
    price: 420,
    oldPrice: 520,
    imageUrl: 'https://images.unsplash.com/photo-1604754742629-3e5728249d73?w=600&h=600&fit=crop&auto=format',
  ...
  },
  {
    ...
    brand: 'Bosch',
    price: 380,
    imageUrl: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&h=600&fit=crop&auto=format',
...
async function seedMockData() {
  try {
    ...
    const toInsert = mockProducts.filter(p => !existingRefs.includes(p.reference));

    if (toInsert.length === 0) {
      console.log('ℹ️  Mock products already seeded.');
    } else {
      const inserted = await Product.insertMany(toInsert);
      console.log(`✅ Seeded ${inserted.length} mock products`);
    }
    process.exit(0);
  } catch (err) {
